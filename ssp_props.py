...
class SonicSoundPictureTemplatePropertyGroup(bpy.types.PropertyGroup):
    ...
    license  : bpy.props.EnumProperty(name = "License", description = "The license of your template", default="all-rights-reserved", items = (
        ...
        ('licenses/by-3.0', "Attribution", "This license lets others distribute, remix, tweak, and build upon your work, even commercially, as long as they credit you for the original creation. This is the most accommodating of licenses offered, in terms of what others can do with your works licensed under Attribution."),  
